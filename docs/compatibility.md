...
| --- | --- | --- | --- |
| current NazoAuthCtl v0.1.26 source, built once | v0.1.24 signed host + OCI | 1 | artifact/identity matrix-tested |
| current NazoAuthCtl v0.1.26 source, built once | v0.1.20 signed host + OCI | 1 | matrix and real-backend tested |
| current NazoAuthCtl v0.1.26 source, built once | v0.1.19 signed host + OCI | 1 | matrix-tested |
