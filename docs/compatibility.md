...
| --- | --- | --- | --- |
| current NazoAuthCtl v0.1.21 source, built once | v0.1.20 signed host + OCI | 1 | matrix and real-backend tested |
| current NazoAuthCtl v0.1.21 source, built once | v0.1.19 signed host + OCI | 1 | matrix-tested |
| signed independent NazoAuthCtl v0.1.20 | v0.1.20 signed host + OCI | 1 | artifact/identity matrix-tested |
| signed independent NazoAuthCtl v0.1.20 | v0.1.19 signed host + OCI | 1 | artifact/identity matrix-tested |
...
The previous ctl cell is the signed independent NazoAuthCtl v0.1.20 Release.
